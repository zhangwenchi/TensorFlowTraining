...
A1 = tf.Variable(tf.random_normal(shape=[3, hidden_layer_node]))
b1 = tf.Variable(tf.random_normal(shape=[hidden_layer_node]))
A2 = tf.Variable(tf.random_normal(shape=[hidden_layer_node, 1]))
